...
import com.qa.api.pojo.ContactsAPI_Credentials;
...
public class ContactsAPITest  extends BaseTest {
	...
	public void generateToken() {
		ContactsAPI_Credentials cred = ContactsAPI_Credentials.builder()
		...
		Response response = restClient.post(BASE_URL_CONTACTS,"/users/login", cred, null, null, AuthType.NO_AUTH, ContentType.JSON);
		 ...
		 ConfigManagers.set("contacts_bearer_token",tokenId);
	}
	@Test
